	...
	gfx( wnd )
{
	...
	// colliding objects
	m_bodies.emplace_back( new Body( .15f, { -.5f, 0.f }, .5f, .3f, Shape::CIRCLE ) );
	m_bodies.emplace_back( new Body( .15f, { 0.f, .8f }, .5f, .3f, Shape::CIRCLE ) );
	m_bodies.emplace_back( new Body( .15f, { -.5f, -.5f }, 0.f, .3f, Shape::CIRCLE ) );
