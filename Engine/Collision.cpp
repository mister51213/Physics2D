...
bool CirclevCircle( Square & A, const Square & B, Vec2 & normal, float & penetration )
{
	return false;
}

bool AABBvCircle( Square & A, const Square & B, Vec2 & normal, float & penetration )
{
	return false;
}

bool CirclevNgon( Square & A, const Square & B, Vec2 & normal, float & penetration )
{
	return false;
}
